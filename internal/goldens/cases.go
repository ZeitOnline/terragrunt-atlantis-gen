...
var Cases = []Case{
	...
	{Name: "TestCustomWorkflowName", Args: []string{"--root", "testdata/fixtures/different_workflow_names"}},
	{Name: "TestUnparseableParent", Args: []string{"--root", "testdata/fixtures/invalid_parent_module"}},
	{Name: "TestWithWorkspaces", Args: []string{"--root", "testdata/fixtures/basic_module", "--create-workspace"}},
	{Name: "TestWithProjectNames", Args: []string{"--root", "testdata/fixtures/invalid_parent_module", "--create-project-name"}},
	{Name: "TestMergingLocalDependenciesFromParent", Args: []string{"--root", "testdata/fixtures/parent_with_extra_deps"}},
	{Name: "TestWorkflowFromParentInLocals", Args: []string{"--root", "testdata/fixtures/parent_with_workflow_local"}},
	{Name: "TestChildWorkflowOverridesParentWorkflow", Args: []string{"--root", "testdata/fixtures/child_and_parent_specify_workflow"}},
	{Name: "TestExtraArguments", Args: []string{"--root", "testdata/fixtures/extra_arguments"}},
	{Name: "TestInfrastructureLive", Args: []string{"--root", "testdata/fixtures/terragrunt-infrastructure-live-example"}},
	{Name: "TestModulesWithNoTerraformSourceDefinitions", Args: []string{"--root", "testdata/fixtures/no_terraform_blocks", "--parallel", "--autoplan"}},
	{Name: "TestInfrastructureMutliAccountsVPCRoute53TGWCascading", Args: []string{"--root", "testdata/fixtures/multi_accounts_vpc_route53_tgw", "--cascade-dependencies"}},
	{Name: "TestAutoPlan", Args: []string{"--root", "testdata/fixtures/autoplan", "--autoplan=false"}},
	{Name: "TestSkippingModules", Args: []string{"--root", "testdata/fixtures/skip"}},
	{Name: "TestTerraformVersionConfig", Args: []string{"--root", "testdata/fixtures/terraform_version", "--terraform-version", "0.14.9001"}},
	...
	{Name: "TestApplyRequirementsLocals", Args: []string{"--root", "testdata/fixtures/apply_requirements_overrides"}},
	{Name: "TestApplyRequirementsFlag", Args: []string{"--root", "testdata/fixtures/basic_module", "--apply-requirements=approved,mergeable"}},
	{Name: "TestFilterFlagWithInfraLiveProd", Args: []string{"--root", "testdata/fixtures/terragrunt-infrastructure-live-example", "--filter", "testdata/fixtures/terragrunt-infrastructure-live-example/prod"}},
	{Name: "TestFilterFlagWithInfraLiveNonProd", Args: []string{"--root", "testdata/fixtures/terragrunt-infrastructure-live-example", "--filter", "testdata/fixtures/terragrunt-infrastructure-live-example/non-prod"}},
	{Name: "TestFilterFlagWithInfraLiveProdAndNonProd", Args: []string{"--root", "testdata/fixtures/terragrunt-infrastructure-live-example", "--filter", "testdata/fixtures/terragrunt-infrastructure-live-example/non-prod,testdata/fixtures/terragrunt-infrastructure-live-example/prod"}},
	{Name: "TestFilterGlobFlagWithInfraLiveMySql", Args: []string{"--root", "testdata/fixtures/terragrunt-infrastructure-live-example", "--filter", "testdata/fixtures/terragrunt-infrastructure-live-example/*/*/*/mysql"}},
	{Name: "TestMultipleIncludes", Args: []string{"--root", "testdata/fixtures/multiple_includes", "--terraform-version", "0.14.9001"}},
	...
	{Name: "TestEnvHCLProjectsWithDeps", Args: []string{"--root", "testdata/fixtures/proj_hcl_with_external_deps/my-stack", "--cascade-dependencies", "--project-hcl-files=stack.hcl", "--create-hcl-project-childs=false", "--create-hcl-project-external-childs=false"}},
	{Name: "TestEnvHCLProjectsNoChilds", Args: []string{"--root", "testdata/fixtures", "--project-hcl-files=env.hcl", "--create-hcl-project-childs=false", "--create-hcl-project-external-childs=false"}},
	{Name: "TestEnvHCLProjectsSubChilds", Args: []string{"--root", "testdata/fixtures", "--project-hcl-files=env.hcl", "--create-hcl-project-childs=true", "--create-hcl-project-external-childs=false"}},
	{Name: "TestEnvHCLProjectsExternalChilds", Args: []string{"--root", "testdata/fixtures", "--project-hcl-files=env.hcl", "--create-hcl-project-childs=false", "--create-hcl-project-external-childs=true"}},
	{Name: "TestEnvHCLProjectsAllChilds", Args: []string{"--root", "testdata/fixtures", "--project-hcl-files=env.hcl", "--create-hcl-project-childs=true", "--create-hcl-project-external-childs=true"}},
	{Name: "TestEnvHCLProjectMarker", Args: []string{"--root", "testdata/fixtures/project_hcl_with_project_marker", "--project-hcl-files=env.hcl", "--use-project-markers=true"}},
	{Name: "TestWithOriginalDir", Args: []string{"--root", "testdata/fixtures/with_original_dir"}},
